	...
	?>
		...
		<div id="tdb">
				<table id="tableau_tdb">
					...
					<tr>
						<td class="critere"><?php $temperature ?> + °C</td>
...
function listecapteurlampe()
{
	...
	function scenario() 
	{
	    document.getElementById("demo").innerHTML = "<div class='cadre'><form method='POST' action=''><p>Nom du Scénario</p><input type='text' name='nom_scenario'><br /><br /><label>Type d'action : </label><select name='choix_action'><option value='defaulth' selected='selected'>Action</option><option value='1'>Allumer</option><option value='0'>Eteindre</option></select><p>Date de début : <input type='date' name='date_debut'></p><p>Date de fin : <input type='date' name='date_fin'></p><p>Heure d'allumage ?</p><p><select name='choixh_d'><option value='defaulth' selected='selected'>Heure</option><option value='00'>00</option><option value='01'>01</option><option value='02'>02</option><option value='03'>03</option><option value='04'>04</option><option value='05'>05</option><option value='06'>06</option><option value='07'>07</option><option value='08'>08</option><option value='09'>09</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option></select>h<select name='choixm_d'><option value='defaultm' selected='selected'>Minute</option><option value='00'>00</option><option value='15'>15</option><option value='30'>30</option><option value='45'>45</option></select></p><p>Heure d'extinction ?</p><p><select name='choixh_f'><option value='defaulth' selected='selected'>Heure</option><option value='00'>00</option><option value='01'>01</option><option value='02'>02</option><option value='03'>03</option><option value='04'>04</option><option value='05'>05</option><option value='06'>06</option><option value='07'>07</option><option value='08'>08</option><option value='09'>09</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option></select>h<select name='choixm_f'><option value='defaultm' selected='selected'>Minute</option><option value='0'>00</option><option value='15'>15</option><option value='30'>30</option><option value='45'>45</option></select></p><p><input type='submit' name='formscenario'></p></form></div>";
	}
	</script>
...
function listecapteurchauffage()
{
	...
	function scenario() 
	{
	    document.getElementById("demo").innerHTML = "<div class='cadre'><form method='POST' action=''><p>Nom du Scénario</p><input type='text' name='nom_scenario'><br /><br /><label>Type d'action :</label><select name='choix_action'><option value='defaulth' selected='selected'>Action</option><option value='1'>Allumer</option><option value='0'>Eteindre</option></select><br><br><label>Date de début : </label><input type='text' name='date_debut' placeholder='17/02/2017'><br><br><label>Date de fin : </label><input type='text' name='date_fin' placeholder='26/02/2017'><p>Heure d'allumage ?</p><p><select name='choixh'><option value='defaulth' selected='selected'>Heure</option><option value='choix0'>00</option><option value='choix0'>01</option><option value='choix2'>02</option><option value='choix3'>03</option><option value='choix4'>04</option><option value='choix5'>05</option><option value='choix6'>06</option><option value='choix7'>07</option><option value='choix8'>08</option><option value='choix9'>09</option><option value='choix10'>10</option><option value='choix11'>11</option><option value='choix12'>12</option><option value='choix13'>13</option><option value='choix14'>14</option><option value='choix15'>15</option><option value='choix16'>16</option><option value='choix17'>17</option><option value='choix18'>18</option><option value='choix19'>19</option><option value='choix20'>20</option><option value='choix21'>21</option><option value='choix22'>22</option><option value='choix23'>23</option></select>h<select name='choixm'><option value='defaultm' selected='selected'>Minute</option><option value='min0'>00</option><option value='min15'>15</option><option value='min30'>30</option><option value='min45'>45</option></select></p><p>Heure d'extinction ?</p><p><select name='choixh'><option value='defaulth' selected='selected'>Heure</option><option value='choix0'>00</option><option value='choix2'>02</option><option value='choix3'>03</option><option value='choix4'>04</option><option value='choix5'>05</option><option value='choix6'>06</option><option value='choix7'>07</option><option value='choix8'>08</option><option value='choix9'>09</option><option value='choix10'>10</option><option value='choix11'>11</option><option value='choix12'>12</option><option value='choix13'>13</option><option value='choix14'>14</option><option value='choix15'>15</option><option value='choix16'>16</option><option value='choix17'>17</option><option value='choix18'>18</option><option value='choix19'>19</option><option value='choix20'>20</option><option value='choix21'>21</option><option value='choix22'>22</option><option value='choix23'>23</option></select>h<select name='choixm'><option value='defaultm' selected='selected'>Minute</option><option value='min0'>00</option><option value='min15'>15</option><option value='min30'>30</option><option value='min45'>45</option></select></p><p><input type='submit' name='formscenario'></p></form></div>";
	}
	</script>
...
function listecapteurvolet()
{
	...
	function scenario() 
	{
	    document.getElementById("demo").innerHTML = "<div class='cadre'><form method='POST' action=''><p>Date de début :</p><p><input type='text' name='date_debut' placeholder='17/02/2017'></p><p>Date de fin :</p><p><input type='text' name='date_fin' placeholder='26/02/2017'></p><p>Heure d'allumage ?</p><p><select name='choixh'><option value='defaulth' selected='selected'>Heure</option><option value='choix0'>00</option><option value='choix0'>01</option><option value='choix2'>02</option><option value='choix3'>03</option><option value='choix4'>04</option><option value='choix5'>05</option><option value='choix6'>06</option><option value='choix7'>07</option><option value='choix8'>08</option><option value='choix9'>09</option><option value='choix10'>10</option><option value='choix11'>11</option><option value='choix12'>12</option><option value='choix13'>13</option><option value='choix14'>14</option><option value='choix15'>15</option><option value='choix16'>16</option><option value='choix17'>17</option><option value='choix18'>18</option><option value='choix19'>19</option><option value='choix20'>20</option><option value='choix21'>21</option><option value='choix22'>22</option><option value='choix23'>23</option></select>h<select name='choixm'><option value='defaultm' selected='selected'>Minute</option><option value='min0'>00</option><option value='min15'>15</option><option value='min30'>30</option><option value='min45'>45</option></select></p><p>Heure d'extinction ?</p><p><select name='choixh'><option value='defaulth' selected='selected'>Heure</option><option value='choix0'>00</option><option value='choix2'>02</option><option value='choix3'>03</option><option value='choix4'>04</option><option value='choix5'>05</option><option value='choix6'>06</option><option value='choix7'>07</option><option value='choix8'>08</option><option value='choix9'>09</option><option value='choix10'>10</option><option value='choix11'>11</option><option value='choix12'>12</option><option value='choix13'>13</option><option value='choix14'>14</option><option value='choix15'>15</option><option value='choix16'>16</option><option value='choix17'>17</option><option value='choix18'>18</option><option value='choix19'>19</option><option value='choix20'>20</option><option value='choix21'>21</option><option value='choix22'>22</option><option value='choix23'>23</option></select>h<select name='choixm'><option value='defaultm' selected='selected'>Minute</option><option value='min0'>00</option><option value='min15'>15</option><option value='min30'>30</option><option value='min45'>45</option></select></p><p><input type='submit' name='formscenario'></p></form></div>";
	}
	</script>
