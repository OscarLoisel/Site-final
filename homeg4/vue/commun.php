...
function listecapteurlampe()
{
	...
	function scenario() 
	{
	    document.getElementById("demo").innerHTML = "<div class='cadre'><form method='POST' action=''><p>Nom du Scénario</p><input type='text' name='nom_scenario'><p>Date de début :</p><p><input type='date' name='date_debut' placeholder='17/02/2017'></p><p>Date de fin :</p><p><input type='date' name='date_fin' placeholder='26/02/2017'></p><p>Heure d'allumage ?</p><p><select name='choixh_d'><option value='defaulth' selected='selected'>Heure</option><option value='0'>00</option><option value='1'>01</option><option value='2'>02</option><option value='3'>03</option><option value='4'>04</option><option value='5'>05</option><option value='6'>06</option><option value='7'>07</option><option value='8'>08</option><option value='9'>09</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option></select>h<select name='choixm_d'><option value='defaultm' selected='selected'>Minute</option><option value='0'>00</option><option value='15'>15</option><option value='30'>30</option><option value='45'>45</option></select></p><p>Heure d'extinction ?</p><p><select name='choixh_f'><option value='defaulth' selected='selected'>Heure</option><option value='0'>00</option><option value='1'>01</option><option value='2'>02</option><option value='3'>03</option><option value='4'>04</option><option value='5'>05</option><option value='6'>06</option><option value='7'>07</option><option value='8'>08</option><option value='9'>09</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option></select>h<select name='choixm_f'><option value='defaultm' selected='selected'>Minute</option><option value='0'>00</option><option value='15'>15</option><option value='30'>30</option><option value='45'>45</option></select></p><p><input type='submit' name='formscenario'></p></form></div>";
	}
	</script>
