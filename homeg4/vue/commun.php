...
function listecapteurchauffage()
{
	...
	function scenario() 
	{
	    document.getElementById("demo").innerHTML = "<div class='cadre'><form method='POST' action=''><p>Nom du Scénario<br /><input type='text' name='nom_scenario'></p><br /><table><p><tr><td><label>Type d'action : </label></td><td><input type='number' name='valeur' placeholder='20'>°C</td></tr></p><p><tr><td><label>Date de début : </label></td><td><input type='date' name='date_debut' placeholder='JJ/MM/AAAA'></td><tr></p><p><tr><td><label>Date de fin : </label></td><td><input type='date' name='date_fin' placeholder='JJ/MM/AAAA'></td></tr></p></table><br /><p>Heure d'allumage ?<br /><select name='choixh'><option value='defaulth' selected='selected'>Heure</option><option value='choix0'>00</option><option value='choix0'>01</option><option value='choix2'>02</option><option value='choix3'>03</option><option value='choix4'>04</option><option value='choix5'>05</option><option value='choix6'>06</option><option value='choix7'>07</option><option value='choix8'>08</option><option value='choix9'>09</option><option value='choix10'>10</option><option value='choix11'>11</option><option value='choix12'>12</option><option value='choix13'>13</option><option value='choix14'>14</option><option value='choix15'>15</option><option value='choix16'>16</option><option value='choix17'>17</option><option value='choix18'>18</option><option value='choix19'>19</option><option value='choix20'>20</option><option value='choix21'>21</option><option value='choix22'>22</option><option value='choix23'>23</option></select>h<select name='choixm'><option value='defaultm' selected='selected'>Minute</option><option value='min0'>00</option><option value='min15'>15</option><option value='min30'>30</option><option value='min45'>45</option></select></p><p>Heure d'extinction ?<br /><select name='choixh'><option value='defaulth' selected='selected'>Heure</option><option value='choix0'>00</option><option value='choix2'>02</option><option value='choix3'>03</option><option value='choix4'>04</option><option value='choix5'>05</option><option value='choix6'>06</option><option value='choix7'>07</option><option value='choix8'>08</option><option value='choix9'>09</option><option value='choix10'>10</option><option value='choix11'>11</option><option value='choix12'>12</option><option value='choix13'>13</option><option value='choix14'>14</option><option value='choix15'>15</option><option value='choix16'>16</option><option value='choix17'>17</option><option value='choix18'>18</option><option value='choix19'>19</option><option value='choix20'>20</option><option value='choix21'>21</option><option value='choix22'>22</option><option value='choix23'>23</option></select>h<select name='choixm'><option value='defaultm' selected='selected'>Minute</option><option value='min0'>00</option><option value='min15'>15</option><option value='min30'>30</option><option value='min45'>45</option></select></p><br /><p><input type='submit' name='formscenario'></p></form></div>";
	}
	</script>
